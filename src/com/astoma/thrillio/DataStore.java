...
import com.astoma.thrillio.constants.Gender;
import com.astoma.thrillio.constants.UserType;
import com.astoma.thrillio.entities.Bookmark;
import com.astoma.thrillio.entities.User;
import com.astoma.thrillio.entities.UserBookmark;
...
public class DataStore {
	...
	private static void loadUsers() {
		...
		users[3] = UserManager.getInstance().createUser(1003,
				"user3@semanticsquare.com", "test", "Sarah", "M", Gender.MALE,
				UserType.USER);
	...
	public static void loadBooks() {
		...
		bookmarks[2][1] = BookmarkManager.getInstance().createBook(4001,
				...
				new String[] { "Ralph Waldo Emerson" }, "Philosophy", 4.5);
